...
typedef enum UAGithubRequestType 
{
    ...
    UAGithubRepositoryContentCreateRequest,
    UAGithubRepositoryContentUpdateRequest,
    UAGithubRepositoryContentGetRequest,
...
typedef enum UAGithubResponseType 
{
    ...
    UAGithubRepositoryContentCreateResponse,
    UAGithubRepositoryContentUpdateResponse,
    UAGithubRepositoryContentGetResponse,
